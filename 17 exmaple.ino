...
#define PIN_LED 9
#define PIN_SERVO 6
#define _DUTY_MIN 50  // servo full clock-wise position (0 degree)
#define _DUTY_NEU 845  // servo neutral position (90 degree)
#define _DUTY_MAX 1640  // servo full counter-clockwise position (180 degree)
